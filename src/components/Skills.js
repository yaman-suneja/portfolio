...
class Skills extends Component {
  ...
  init() {
    ...
    */
    ...
    setTimeout(() => {
      gravities.push(new GravityPoint(screenWidth / 2, screenHeight / 2, G_POINT_RADIUS, {
        particles: particles,
        gravities: gravities
      }));
    }, 10 * 1000);
  ...
  render() {
    if (this.props.sharedSkills && this.props.resumeBasicInfo) {
      ...
      var skills = this.props.sharedSkills.icons.map(function (skills, i) {
        return (
          <li className="list-inline-item mx-3" key={i} title={skills.name}>
            <span>
    ...
    return (
      <section id="skills">
        <canvas id="skills-canvas" ref={ref => { if (ref) { this.init(); } }} />
        <div className="col-md-12">
          <div className="col-md-12">
            <h1 className="section-title header-label">
